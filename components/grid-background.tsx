    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-4 max-w-3xl mx-auto space-y-6 pointer-events-none">
         <div className="space-y-2">
          <h1 className="text-xl md:text-6xl font-extrabold tracking-tight text-foreground drop-shadow-sm">
          Build Mobile Apps in Minutes          </h1>
          <p className="text-sm md:text-xl text-muted-foreground">
          g0-app is an open-source Expo mobile app builder.<br/>
